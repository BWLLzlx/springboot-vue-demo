...
<!--      </div>-->
    ...
    <!--提示款区域-->
    <div>
      <el-dialog v-model="dialogVisible" title="付款" width="400px">
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="商品名称">
            <el-input v-model="form.goodsName" style="width:80%" disabled></el-input>
          </el-form-item>
          <el-form-item label="商品价格">
            <el-input v-model="form.price" style="width:80%" disabled></el-input>
          </el-form-item>
          <el-form-item label="购买时间">
            <el-date-picker v-model="form.createTime" disabled value-format="YYYY-MM-DD" type="date" style="width:80%" clearable></el-date-picker>
          </el-form-item>
...
export default {
  ...
  methods:{
    ...
    save() {
      request.put("/api/man/manList",this.form).then(res => {
        console.log(res)
        if(res.code === '0'){
          ElMessage('修改成功')
